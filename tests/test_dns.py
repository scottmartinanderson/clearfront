...
async def test_nxdomain_returns_does_not_exist() -> None:
    with patch("clearfront.tools.search_dns.dns.resolver.Resolver") as MockResolver:
...
async def test_standard_domain_has_a_mx_ns() -> None:
    ...
    with patch("clearfront.tools.search_dns.dns.resolver.Resolver") as MockResolver:
        ...
        with patch("clearfront.tools.search_dns.asyncio.get_event_loop") as mock_loop:
